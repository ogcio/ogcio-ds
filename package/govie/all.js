(function (global, factory) {
  ...
  function Accordion($module, config) {
    ...
    this.sectionClass = 'govie-accordion__section';
    ...
    this.sectionHeadingDividerClass = 'govie-accordion__section-heading-divider';
    ...
    this.sectionContentClass = 'govie-accordion__section-content';
   ...
   *
   * See https://github.com/alphagov/govie_elements/pull/272#issuecomment-233028270
   *
  ...
  function CharacterCount($module, config) {
    ...
    var $textarea = $module.querySelector('.govie-js-character-count');
    if (
      !(
  ...
  CharacterCount.prototype.init = function () {
    ...
    $screenReaderCountMessage.className =
      'govie-character-count__sr-status govie-visually-hidden';
    ...
    $textareaDescription.classList.add('govie-visually-hidden');
  ...
  CharacterCount.prototype.updateVisibleCountMessage = function () {
    ...
    if (this.isOverThreshold()) {
      $visibleCountMessage.classList.remove(
        'govie-character-count__message--disabled'
      );
    } else {
   ...
   *   messages](https://frontend.design-system.service.gov.uk/localise-govie-frontend).
