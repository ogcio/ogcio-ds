...
Default.args = {
  items: [
    {
      heading: 'Writing well for the web',
      content: `<p class='govie-body'>This is the content for Writing well for the web.</p>`,
    },
    {
      heading: 'Writing well for specialists',
      content: `<p class='govie-body'>This is the content for Writing well for specialists.</p>`,
    },
    {
      heading: 'Know your audience',
      content: `<p class='govie-body'>This is the content for Know your audience.</p>`,
    },
    {
      heading: 'How people read',
      content: `<p class='govie-body'>This is the content for How people read.</p>`,
    },
  ],
}
