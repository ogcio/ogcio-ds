...
const Template = (args) => {
  ...
  a.innerHTML = `
    <span class="govie-header__logotype">
      <!--[if gt IE 8]><!-->
      <svg aria-hidden="true" focusable="false" class="govie-header__logotype-crown" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132 97" height="30" width="36">
      ...
      <!--<![endif]-->
      <!--[if IE 8]>
      <img src="/assets/images/govie-logotype-harp.png" class="govie-header__logotype-harp-fallback-image" width="36" height="32">
      <![endif]-->
      <span class="govie-header__logotype-text">
        gov.ie
      </span>
    </span>
  `
