...
describe('Error message', () => {
  ...
  it('renders with a custom id', () => {
    ...
    const $component = $('.govie-error-message')
  ...
  it('allows text to be passed whilst escaping HTML entities', () => {
    ...
    const content = $('.govie-error-message').html().trim()
  ...
  it('allows the visually hidden prefix to be removed and then manually added with HTML', () => {
    ...
    const $component = $('.govie-error-message')
    expect($component.html().trim()).toContain('<span class="govie-visually-hidden">Gwall:</span> Neges gwall am yr enw llawn yn mynd yma')
  })
})
