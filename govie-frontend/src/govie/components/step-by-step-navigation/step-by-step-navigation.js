...
window.GOVIE = window.GOVIE || {}
window.GOVIE.Modules = window.GOVIE.Modules || {}
;(function (Modules) {
  ...
  AppStepNav.prototype.StepNavTracker = function (
    ...
    this.trackClick = function (category, action, options) {
      ...
      if (window.GOVIE.analytics && window.GOVIE.analytics.trackEvent) {
        options = options || {}
        ...
        window.GOVIE.analytics.trackEvent(category, action, options)
      }
    }
  }

  Modules.AppStepNav = AppStepNav
})(window.GOVIE.Modules)
