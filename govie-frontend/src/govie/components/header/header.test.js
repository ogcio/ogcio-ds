...
describe('Header navigation', () => {
  ...
  describe('when JavaScript is unavailable or fails', () => {
    ...
    it('shows the navigation', async () => {
      const navDisplay = await page.$eval('.govie-header__navigation-list',
    ...
    it('does not show the mobile menu button', async () => {
      const buttonDisplay = await page.$eval('.govie-js-header-toggle',
        el => window.getComputedStyle(el).getPropertyValue('display')
      )
  ...
  describe('when JavaScript is available', () => {
    ...
    describe('on page load', () => {
      ...
      it('reveals the menu button', async () => {
        const hidden = await page.$eval('.govie-js-header-toggle',
      ...
      it('hides the menu via the hidden attribute', async () => {
        const hidden = await page.$eval('.govie-header__navigation-list',
          el => el.hasAttribute('hidden')
        )
      ...
      it('exposes the collapsed state of the menu button using aria-expanded', async () => {
        const ariaExpanded = await page.$eval('.govie-header__menu-button',
    ...
    describe('when menu button is pressed', () => {
      beforeAll(async () => {
        ...
        await page.waitForSelector('.govie-js-header-toggle')
        await page.click('.govie-js-header-toggle')
      })
