...
describe('Checkboxes', () => {
  ...
  it('render example with minimum required name and items', () => {
    ...
    const $component = $('.govie-checkboxes')

    const $firstInput = $component.find('.govie-checkboxes__item:first-child input')
    const $firstLabel = $component.find('.govie-checkboxes__item:first-child label')
    ...
    const $lastInput = $component.find('.govie-checkboxes__item:last-child input')
    const $lastLabel = $component.find('.govie-checkboxes__item:last-child label')
  ...
  it('render example without falsely values', () => {
    ...
    const $component = $('.govie-checkboxes')
    const $items = $component.find('.govie-checkboxes__item')
  ...
  it('render example with a divider and ‘None’ checkbox with exclusive behaviour', () => {
    ...
    const $divider = $component.find('.govie-checkboxes__divider').first()
  ...
  it('render additional label classes', () => {
    ...
    const $component = $('.govie-checkboxes')
    const $label = $component.find('.govie-checkboxes__item label')
  ...
  describe('items', () => {
    ...
    it('render disabled', () => {
      ...
      const $disabledInput = $component.find('.govie-checkboxes__item:last-child input')
    ...
    it('render checked', () => {
      ...
      const $component = $('.govie-checkboxes')
      const $secondInput = $component.find('.govie-checkboxes__item:nth-child(2) input')
      const $lastInput = $component.find('.govie-checkboxes__item:last-child input')
    ...
    it('allows item.checked to override values', () => {
      ...
      const $green = $('.govie-checkboxes').find('input[value="green"]')
  ...
  describe('when they include a hint', () => {
    it('it renders the hint text', () => {
      ...
      const $firstHint = $('.govie-checkboxes__hint').first()
    ...
    it('it renders the correct id attribute for the hint', () => {
      ...
      expect($('.govie-checkboxes__hint').attr('id')).toBe('government-gateway-item-hint')
    })

    it('the input describedBy attribute matches the item hint id', () => {
      const $ = render('checkboxes', examples['with hints on items'])

      expect($('.govie-checkboxes__input').attr('aria-describedby')).toBe('government-gateway-item-hint')
    })
  })
  ...
  describe('render conditionals', () => {
    it('hidden by default when not checked', () => {
      ...
      const $firstConditional = $component.find('.govie-checkboxes__conditional').first()
      expect($firstConditional.text().trim()).toContain('Email address')
      expect($firstConditional.hasClass('govie-checkboxes__conditional--hidden')).toBeTruthy()
    })
    it('visible by default when checked', () => {
      ...
      const $firstConditional = $component.find('.govie-checkboxes__conditional').first()
      expect($firstConditional.text().trim()).toContain('Email address')
      expect($firstConditional.hasClass('govie-checkboxes__conditional--hidden')).toBeFalsy()
    })
    ...
    it('with association to the input they are controlled by', () => {
      ...
      const $lastInput = $component.find('.govie-checkboxes__input').last()
      const $lastConditional = $component.find('.govie-checkboxes__conditional').last()
    ...
    it('omits empty conditionals', () => {
      ...
      const $component = $('.govie-checkboxes')
      expect($component.find('.govie-checkboxes__conditional').length).toEqual(0)
    })

    it('does not associate checkboxes with empty conditionals', () => {
      const $ = render('checkboxes', examples['empty conditional'])

      const $input = $('.govie-checkboxes__input').first()
  ...
  describe('nested dependant components', () => {
    it('have correct nesting order', () => {
      ...
      const $component = $('.govie-form-group > .govie-fieldset > .govie-checkboxes')
    ...
    it('passes through label params without breaking', () => {
      ...
      expect(htmlWithClassName($, '.govie-checkboxes__label')).toMatchSnapshot()
    })
