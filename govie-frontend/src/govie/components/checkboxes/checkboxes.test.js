  ...
  describe('when JavaScript is unavailable or fails', () => {
    ...
    describe('with conditional items', () => {
      ...
      beforeAll(async () => {
        ...
        $component = await page.$('.govie-checkboxes')
        $inputs = await $component.$$('.govie-checkboxes__input')
        $conditionals = await $component.$$('.govie-checkboxes__conditional')
      ...
      it('has no ARIA attributes applied', async () => {
        const $inputsWithAriaExpanded = await $component.$$('.govie-checkboxes__input[aria-expanded]')
        const $inputsWithAriaControls = await $component.$$('.govie-checkboxes__input[aria-controls]')
...
describe('Checkboxes with multiple groups and a "None" checkbox and conditional reveals', () => {
  describe('when JavaScript is available', () => {
    ...
    beforeEach(async () => {
      ...
      $inputsPrimary = await page.$$('.govie-checkboxes__input[id^="colour-primary"]')
      $inputsSecondary = await page.$$('.govie-checkboxes__input[id^="colour-secondary"]')
      $inputsOther = await page.$$('.govie-checkboxes__input[id^="colour-other"]')
    })
