...
describe('Warning text', () => {
  ...
  describe('default example', () => {
    ...
    it('renders with text', () => {
      ...
      const $component = $('.govie-warning-text')
    ...
    it('renders with assistive text', () => {
      ...
      const $assistiveText = $('.govie-warning-text__assistive')
    ...
    it('hides the icon from screen readers using the aria-hidden attribute', () => {
      ...
      const $icon = $('.govie-warning-text__icon')
  ...
  describe('custom options', () => {
    it('renders classes', () => {
      ...
      const $component = $('.govie-warning-text')
      expect($component.hasClass('govie-warning-text--custom-class')).toBeTruthy()
    })
