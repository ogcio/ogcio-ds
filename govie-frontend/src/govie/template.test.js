...
describe('Template', () => {
  ...
  describe('<head>', () => {
    it('can have custom social media icons specified using the headIcons block', () => {
      const headIcons = '<link rel="govie-icon" href="/images/ytf-icon.png">'
      ...
      expect(icons).toEqual(['govie-icon'])
    })
  ...
  describe('<body>', () => {
    ...
    describe('skip link', () => {
      it('can be overridden using the skipLink block', () => {
        ...
        expect($('.govie-skip-link').length).toEqual(0)
      })
    })
    ...
    describe('header', () => {
      it('can be overridden using the header block', () => {
        ...
        expect($('.govie-header').length).toEqual(0)
      })
    })
    ...
    describe('footer', () => {
      it('can be overridden using the footer block', () => {
        ...
        expect($('.govie-footer').length).toEqual(0)
      })
    })
  })
})
