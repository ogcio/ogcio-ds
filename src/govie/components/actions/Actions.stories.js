  ...
  const actions = [
    iconButton({
      icon: createSvgIcon(
        18,
        19,
        'M11.25 16.25L6.75 14.675L3.2625 16.025C3.0125 16.125 2.78125 16.0968 2.56875 15.9403C2.35625 15.7843 2.25 15.575 2.25 15.3125V4.8125C2.25 4.65 2.297 4.50625 2.391 4.38125C2.4845 4.25625 2.6125 4.1625 2.775 4.1L6.75 2.75L11.25 4.325L14.7375 2.975C14.9875 2.875 15.2188 2.903 15.4313 3.059C15.6438 3.2155 15.75 3.425 15.75 3.6875V14.1875C15.75 14.35 15.703 14.4938 15.609 14.6188C15.5155 14.7438 15.3875 14.8375 15.225 14.9L11.25 16.25ZM10.5 14.4125V5.6375L7.5 4.5875V13.3625L10.5 14.4125Z',
    ...
    iconButton({
      icon: createSvgIcon(
        18,
        19,
        'M3 14.25C2.45 14.25 1.97933 14.1033 1.588 13.8097C1.196 13.5157 1 13.1625 1 12.75V3H0V1.5H5V0.75H11V1.5H16V3H15V12.75C15 13.1625 14.8043 13.5157 14.413 13.8097C14.021 14.1033 13.55 14.25 13 14.25H3ZM13 3H3V12.75H13V3ZM5 11.25H7V4.5H5V11.25ZM9 11.25H11V4.5H9V11.25ZM3 3V12.75V3Z'
      ).outerHTML,
      tooltipLabel: 'Delete',
      position,
      disabled,
