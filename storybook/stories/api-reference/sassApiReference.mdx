...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        Name of colour from the colour palette (`$govie-colours`)
      </td>
      <td>
        `String`
      </td>
...
<p>
  ...
  within a `:hover` pseudo-selector. Use this mixin only if you
  cannot use the `govie-link-common` mixin.
</p>
<h5>Usage</h5>
...
<p>
  ...
  `govie-link-common` mixin to get the correct focus and hover
  states.
</p>
<h5>Usage</h5>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        Direction to add spacing to (`top`, `right`,{' '}
        `bottom`, `left`, `all`)
      </td>
      <td>
        `String`
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        Whether to mark declarations as `!important`. Generally Used
...
<h5>Usage</h5>
```css
@include govie-typography-weight-bold($important: false);
```
...
<h5>Usage</h5>
```css
@include govie-typography-responsive($size, $override-line-height: false, $important: false);
```
