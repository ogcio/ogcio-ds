...
<p>
  ...
  components. You can find further information on how to [configure these
  options in our
  guidance](/?path=/docs/docs-configure-components-with-javascript--page).
</p>

You can pass these options in an object either as:

- a second argument of the component's constructor
- the value for the key of the component name in an object passed to <code>initAll</code>
...
<p>
  ...
  This is a [pluralised list of
  messages](/?path=/story/docs-localise-ogcio-ds--page#pluralisation-rules).
</p>
<p>Default:</p>
...
<p>
  ...
  with the number of remaining words. This is a [pluralised list of messages](/?path=/story/docs-localise-ogcio-ds--page#pluralisation-rules)
</p>
<p>Default:</p>
