...
<p>
  ...
  <a href="/?path=/docs/docs-configure-components-with-javascript--page">
...
<p>
  ...
  This is a{' '}
  <a href="/?path=/story/docs-localise-ogcio-ds--page#pluralisation-rules">
...
<p>
  ...
  with the number of remaining words. This is a <a href="/?path=/story/docs-localise-ogcio-ds--page#pluralisation-rules">
    pluralised list of messages
  </a>.
</p>
<p>Default:</p>
