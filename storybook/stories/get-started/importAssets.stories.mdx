...
<Meta title="Docs/Setup/Import CSS, assets and JavaScript" />
...
<Code code={`@import "@ogcio/ogcio-ds/govie/all";`} />
...
<Code code={`@import "@ogcio/ogcio-ds/govie/components/button/button";`} />
...
<p>
  For example if you're using <a href="https://expressjs.com/">express.js</a>,
...
<Code code={`$govie-assets-path: "/<YOUR-ASSETS-FOLDER>/";`} />
<p>
...
<p>
  ...
  <a href="https://github.com/rails/sass-rails">sass-rails</a>. Set the{' '}
  <code>$govie-image-url-function</code> and{' '}
  <code>$govie-font-url-function</code> variables to the name of your function.
</p>
...
<p>
  If you need to import all of GOV.UK Frontend's components, then run the{' '}
...
<p>
  ...
  <a href="http://browserify.org/" targe="_blank" rel="noopener">
    Browserify
  </a>
...
<Code code={`sha256-+6WnXIl4mbFTCARd8N3COQmT3bJJmo32N8q8ZSQAIcU=`} />
