...
You can update with Node.js package manager (npm) if you <Link textToDisplay='originally installed OGCIO-DS with npm' href='?path=/docs/docs-install-with-npm--docs' />.
