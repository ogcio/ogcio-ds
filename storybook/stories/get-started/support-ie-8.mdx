...
Once you have completed these steps, you will be able to <Link textToDisplay='write CSS that targets IE8 in your own application styles' href='?path=/docs/docs-support-internet-explorer-8--docs/#writing-styles-that-target-ie8' />.

If you <Link textToDisplay='installed using precompiled files' href='?path=/story/docs-install-using-precompiled-files--docs' />, you can include the IE8-specific stylesheet in your project, allowing you to skip steps 2 and 3.
