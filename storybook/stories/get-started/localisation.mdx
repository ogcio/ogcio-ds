...
<p>
  Alternatively, you can [configure the component with
  JavaScript](/?path=/docs/docs-configure-components-with-javascript--page) at
  the point you initialise it or when using <code>initAll</code>.
</p>
...
<p>
  ...
  different ways you can [configure components with
  JavaScript](/?path=/docs/docs-configure-components-with-javascript--page):
</p>
