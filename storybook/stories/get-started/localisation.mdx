...
Alternatively, you can <Link textToDisplay='configure the component with JavaScript' href='?path=/docs/docs-configure-components-with-javascript--docs' /> at the point you initialise it or when using `initAll`.
...
The following example shows how to provide pluralisation options using the different ways you can <Link textToDisplay='configure components with JavaScript' href='?path=/docs/docs-configure-components-with-javascript--docs' />:
