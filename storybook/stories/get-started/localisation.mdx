...
Alternatively, you can <a href={`${import.meta.env.BASE_URL}?path=/docs/docs-configure-components-with-javascript--docs`}>configure the component with JavaScript</a> at the point you initialise it or when using `initAll`.
...
The following example shows how to provide pluralisation options using the different ways you can <a href={`${import.meta.env.BASE_URL}?path=/docs/docs-configure-components-with-javascript--docs`}>configure components with JavaScript</a>:
