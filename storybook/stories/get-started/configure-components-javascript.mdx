...
Read the <Link textToDisplay='JavaScript API Reference' href='?path=/docs/docs-javascript-api-reference--docs' /> for the configuration accepted by each component. You'll need to convert the configuration names into kebab-case.
...
Read the <Link textToDisplay='JavaScript API Reference' href='?path=/docs/docs-javascript-api-reference--docs' /> to see what configuration each component accepts.
