...
- <Link textToDisplay='Install OGCIO-DS using npm' href='?path=/docs/docs-install-with-npm--docs' />

- If you've <Link textToDisplay='installed using precompiled files' href='?path=/story/docs-install-using-precompiled-files--docs' />, get started with a <Link textToDisplay='a basic page instead' href='?path=/story/docs-install-using-precompiled-files--docs#basic-example-page' />

## 2. Add the HTML for a component to your application

Go to the <Link textToDisplay='example accordion component' href='?path=/docs/typography-accordion--default' />
...
There are also different ways you can <Link textToDisplay='import OGCIO-DS CSS' href='?path=/docs/docs-import-css-assets-and-javascript--docs' />.
...
In your live application, we recommend <Link textToDisplay='using an automated task or your build pipeline' href='?path=/docs/docs-import-css-assets-and-javascript--docs#fonts-and-images-assets' /> instead of copying the files manually.
...
We recommend <Link textToDisplay='using an automated task or your build pipeline' href='?path=/docs/docs-import-css-assets-and-javascript--docs#import-javascript' /> instead of copying the files manually
