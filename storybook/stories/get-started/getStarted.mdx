...
<p>
  ...
  <InternalLink href="/?path=/docs/typography-accordion--default" target="_blank" rel="noopener">
...
<ol>
  ...
  <li>
    <p>
      ...
      <a href="https://developer.mozilla.org/en-US/docs/Tools/Page_Inspector/How_to/Edit_fonts#The_Fonts_tab" target="_blank" rel="noopener">
...
`}
  ...
  <li>
    <p>
      Copy the <code>/node\_modules/@ogcio/ogcio-ds/govie/all.js</code> file to{' '}
