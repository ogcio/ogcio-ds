...
<p>
  <a
    className="govie-link govie-body"
    href="/?path=/docs/docs-setup-install-with-npm--page"
  >
...
<p>
  If you've{' '}
  <a href="/?path=/docs/docs-setup-install-using-precompiled-files--page">
    installed using precompiled files
  </a>
  , get started with <a href="/?path=/docs/docs-setup-install-using-precompiled-files--page#basic-example-page">
    a basic page
  </a> instead.
</p>
...
<p>
  ...
  <a href="/?path=/docs/docs-setup-import-css-assets-and-javascript--page">
    import OGCIO-DS CSS
  </a>
  .
</p>
...
<p>
  ...
  <a href="/?path=/docs/docs-setup-import-css-assets-and-javascript--page#fonts-and-images-assets">
...
<ul>
  ...
  <li>
    <p>
      we recommend{' '}
      <a href="/?path=/docs/docs-setup-import-css-assets-and-javascript--page#import-javascript">
        using an automated task or your build pipeline
      </a>{' '}
      instead of copying the files manually
    </p>
