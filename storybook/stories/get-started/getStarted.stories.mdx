...
<p>
  If you've{' '}
  <PrefixedLink href="/?path=/story/docs-install-using-precompiled-files--page">
    installed using precompiled files
  </PrefixedLink>
  , get started with <PrefixedLink href="/?path=/story/docs-install-using-precompiled-files--page#basic-example-page">
    a basic page
  </PrefixedLink> instead.
</p>
...
<p>
  ...
  <PrefixedLink href="/?path=/docs/docs-import-css-assets-and-javascript--page">
    import OGCIO-DS CSS
  </PrefixedLink>
  .
</p>
...
<p>
  ...
  <PrefixedLink href="/?path=/docs/docs-import-css-assets-and-javascript--page#fonts-and-images-assets">
...
<ul>
  ...
  <li>
    <p>
      we recommend{' '}
      <PrefixedLink href="/?path=/docs/docs-import-css-assets-and-javascript--page#import-javascript">
        using an automated task or your build pipeline
      </PrefixedLink>{' '}
      instead of copying the files manually
    </p>
