...
<Meta title="Docs/Setup/Get Started" />
...
<h2>1. Install</h2>
<p>
  <a className="govie-link govie-body" href="/?path=/docs/docs-setup-install--page">
    Install OGCIO-DS using npm
  </a>
</p>
<p>
  If you've installed using precompiled files, get started with{' '}
  <a href="/?path=/docs/patterns-basic-template--default">a basic page</a>{' '}
  instead.
</p>
...
<p>
  ...
  <a href="/importing-css-assets-and-javascript/#css">import OGCIO-DS CSS</a>.
</p>
...
<p>
  ...
  <a href="/importing-css-assets-and-javascript/#font-and-image-assets">
...
<ul>
  ...
  <li>
    <p>
      we recommend{' '}
      <a href="/importing-css-assets-and-javascript/#javascript">
        using an automated task or your build pipeline
      </a>{' '}
      instead of copying the files manually
    </p>
