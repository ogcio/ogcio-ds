...
<p>
  For example if you're using [express.js](https://expressjs.com/), add the following to your <code>app.js</code> file:
</p>
<CodeSnippet
...
<p>
  ...
  [sass-rails](https://github.com/rails/sass-rails). Set the
  `$govie-image-url-function` and `$govie-font-url-function` variables to the
...
<ul>
  <li>
    ...
    `node_modules/@ogcio/ogcio-ds/govie/all.js`
  </li>
  <li>
    copy the `node_modules/@ogcio/ogcio-ds/govie/all.js` file into your
    application
  </li>
</ul>
<p>
