...
<h3>Understanding pluralisation rules</h3>
...
<p>
  ...
  <a
    ...
    rel="noopener"
  >
    the Unicode Common Locale Data Repository documentation for guidance on
    which of these forms your locale requires and what <code>few</code> and{' '}
    <code>many</code> might represent for it
  </a>
  .
</p>
<p>
...
<Code code={`<div data-module="character-count" 
...
<p>With JavaScript</p>
<Code code={`new CharacterCount($element, {
  i18n: {
