...
inputs = {
  s3_bucket_arn = "arn:aws:s3:::storybook-react-design-system-blocks-gov-ie"
  s3_bucket_id  = "storybook-react-design-system-blocks-gov-ie"

  acm_cert_domain_name = "storybook-react.design-system.blocks.gov.ie"

  cf_aliases = ["storybook-react.design-system.blocks.gov.ie"]
